const defaultParams = {
  ...
  // Network Parameters
  numSensorRays: 46, // unitless
  sensorFOV: 90, // degrees
  sensorMaxDistance: 15, // meters
  numMotorNodes: 3, // unitless,
  // number of redundancy motor nodes
  // per side
  targetDataNodeCount: 250, // Rough estimate of
  targetDataNodeCountSigma: 5, // Standard deviation of targetDataNodeCount
  // how many nodes are needed
  // to achieve perfect game
  targetEdgeCount: 2000, // Based on average expected node degree
  // to achieve perfect game
  targetEdgeCountSigma: 5,
  maxAbsoluteNodeValue: 200, // A hard limit to prevent NaN and Inf
  maxAbsoluteEdgeStrength: 10, // A hard limit to prevent NaN and Inf

  // Learning Parameters
  firingThreshold:3.5, // Amount of input "value current" (1/s)
  // needed to fire
  spikeActivationLevel: 1.5, // Amount of value current
  // that a spike carries along an edge
  // upon fire
  visualActivationLevel: 2.5,
  spikeDecayTimeConstant: 0.08, // A spike potency drops to 1/e after tau seconds
  dischargeRate: 0.9,
  leakRate: 0.05,
  motorLeakRate: 0.1,
  // and then we cut it off after 5 tau
  spikeRefractoryPeriod: 0.3, // Time in seconds after a spike
  ...
  speedReward: 0,
  successfulDodgeReward:30,
  centeringReward: 0,
  deathPunishment: 300, // The amount of ambient fitness
  // lost instantaneously on death
  // In the future we may add a damping parameter
  // different than the fitness decay time constant
  hebbianReinforcementTimeConstant:0.85, // This variable name needs to be changed next factor
  edgeStrengthLeakFactor: 0.000,
